document.addEventListener('DOMContentLoaded', function () {
    ...
    editButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            // const paymentTerms = this.getAttribute('data-payment-terms'); // Removed
            ...
            // document.getElementById('edit-payment-terms').value = paymentTerms; // Removed
    ...
    function loadExistingMaterials(supplierId) {
        ...
        existingMaterials.forEach(material => {
            ...
            newMaterialSection.textContent = `${material.name}`; // Removed quantity display
    ...
    document.querySelector('.add-edit-material-button').addEventListener('click', function() {
        ...
        // const quantityInput = document.querySelector('.edit-material-quantity').value; // Removed
        ...
        if (selectedMaterialId) {
            ...
            newMaterialSection.textContent = `${selectedMaterialText}`; // Removed quantity display
            ...
            materialSelect.value = ''; // Reset the select input
            // document.querySelector('.edit-material-quantity').value = ''; // Removed
        } else {
